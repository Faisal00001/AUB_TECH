                                        ...
                                        <div className="hero-overlay  bg-opacity-20 rounded-tr-md">
                                            <div className="container mx-auto">
                                                <div className="pl-28 pt-28">
                                                    ...
                                                    <button className="transition mt-10 ease-in-out delay-150 hover:-translate-y-1  duration-300 text-skin-navLinkText hover:text-skin-footerButtonText font-medium border-solid border-2 border-slate-200 rounded-lg py-3 px-12 text-xl hover:bg-white hover:border-[#FFFFFF]">
                                                        Contact Us
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div className="flex flex-col md:flex-row pl-8 md:pl-16 lg:pl-28  lg:pt-36 md:gap-80 lg:gap-40">
                                        <div>
                                            ...
                                            <div className="mt-4 md:mt-7 space-y-4">
                                                <p className="text-skin-footerText hover:text-skin-footerButtonText cursor-pointer font-medium">Work</p>
                                                <p className="text-skin-footerText hover:text-skin-footerButtonText cursor-pointer font-medium">About</p>
                                                <p className="text-skin-footerText hover:text-skin-footerButtonText cursor-pointer font-medium">Lets Talk</p>
                                        ...
                                        <div className="mt-10 md:mt-0">
                                            ...
                                            <div className="mt-4 md:mt-7 space-y-4">
                                                <p className="text-skin-footerText hover:text-skin-footerButtonText cursor-pointer font-medium">admin@example.com</p>
                                                <p className="text-skin-footerText hover:text-skin-footerButtonText cursor-pointer font-medium">hr@example.com</p>
                                                <div className="flex gap-6 ">
                                                    <div><FaFacebookF className="text-skin-footerText text-lg cursor-pointer transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:text-skin-footerButtonText duration-300"></FaFacebookF></div>
                                                    <div>
                                                        <FaLinkedinIn className="text-skin-footerText text-lg cursor-pointer transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:text-skin-footerButtonText duration-300"></FaLinkedinIn>
                                                    </div>
                                                    <div>
                                                        <FaInstagram className="text-skin-footerText text-lg cursor-pointer transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:text-skin-footerButtonText duration-300"></FaInstagram>
                                                    </div>
                                                    <div>
                                                        <FaTwitter className="text-skin-footerText text-lg cursor-pointer transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:text-skin-footerButtonText duration-300"></FaTwitter>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
