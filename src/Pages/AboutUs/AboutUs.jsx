    ...
    return (
        <div className="flex flex-col lg:flex-row items-center gap-5 my-24 lg:mt-0 ">
            <div className="w-full lg:w-[45%]">
                <img src={mountain} className="h-[550px]  lg:h-[600px] lg:-mt-20 mx-auto w-[80%] rounded-lg" alt="Mountain" />
            </div>
            <div className="w-[80%] lg:w-[55%]">
                <div className="space-y-5 md:pr-10 mt-16 lg:mt-0">
                    <h3 className="text-skin-Heading font-bold text-6xl">About</h3>
                ...
                <div className="flex gap-5 mt-10 ">
                    <div className="space-y-5">
                        <h3 className="text-skin-Heading text-3xl font-medium">Who we are</h3>
